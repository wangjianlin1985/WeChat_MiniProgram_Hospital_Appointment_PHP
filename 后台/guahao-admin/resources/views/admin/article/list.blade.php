    ...
    <script>
        layui.use(["element", "form", "table", "layer"], function () {
            ...
            form.on('submit(search)', function (data) {
                table.reload("layuiTable", { url: "/admin/article/getTable", method: "get", where: data.field });
                return false;
            });
...
@section('content')
    <div class="bar"><a href="">首页</a><a>新闻公告管理</a><span>新闻公告列表</span></div>
    <div class="grid">
        ...
        <div class="gridTable">
            <div class="layui-tables">
                <table id="layuiTable" class="layui-table" lay-data="{url:'/admin/article/getTable',method:'get',page:true}" lay-filter="opt">
                    <thead>
                    <tr>
    ...
    @verbatim
        <script type="text/html" id="optbar">
            <a href="/admin/article/edit/{{d.id}}">编辑</a>
