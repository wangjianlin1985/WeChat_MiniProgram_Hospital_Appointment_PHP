...
@endsection
@section('content')
    <div class="bar"><a href="">首页</a><a>轮播图信息管理</a><span>新增轮播图信息</span></div>
    <form class="layui-form" id="form">
        ...
        <div class="form_container">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input id="url" name="url" class="layui-input" type="text" readonly="readonly"
                           lay-verify="required" lay-reqText="请上传轮播图"/>
                    <button type="button" id="btn">上传轮播图</button>
