...
class ArticleController extends Controller
{
    ...
    {
        $query = $this->getQuery($request,Article::class);
        $count = $query->count();
    ...
    {
        $flag = Article::create($request->all());
    ...
    {
        $flag = Article::where('id',$request->get('id'))->first()->update($request->all());
    ...
    {
        $int = Article::destroy($request->get('id'));
